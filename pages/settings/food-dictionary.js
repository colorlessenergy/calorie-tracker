    ...
    return (
        <div>
            <Head>
                ...
                <meta
                    name="description"
                    content="calorie tracker - food dictionary"
                />
            ...
            <div className="container">
                <div className="mx-15">
                    <h1 className="mt-1">food dictionary</h1>
                    ...
                    <button
                        ...
                        className="button button-green mb-1"
                    >
                        add food
                    </button>
                </div>
                ...
                <div className="flex flex-wrap justify-content-between">
                    {foodDictionary.length
                        ? foodDictionary.map(foodBlock => {
                              return (
                                  <div
                                  ...
                                  >
                                      ...
                                      <div className="align-self-start w-100">
                                          <label
                                              htmlFor={`calculateCalories-${foodBlock.ID}`}
                                          >
                                              calculate calories
                                          </label>
                                          <input
